...
# Credits: https://github.com/opencv/opencv_zoo/tree/main/models/person_detection_mediapipe
...
parser.add_argument('--model', '-m', type=str, default='./models/person_detection_mediapipe_2023mar.onnx',
