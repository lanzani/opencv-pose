...
parser.add_argument('--model', '-m', type=str, default='./models/pose_estimation_mediapipe_2023mar.onnx',
...
if __name__ == '__main__':
    ...
    # person detector
    person_detector = MPPersonDet(modelPath='./models/person_detection_mediapipe_2023mar.onnx',
                                  nmsThreshold=0.3,
                                  scoreThreshold=0.5,
